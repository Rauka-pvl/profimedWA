...
class DoctorResource extends Resource
{
    ...
    protected static string | BackedEnum | null $navigationIcon = 'vaadin-doctor';

    protected static ?string $recordTitleAttribute = 'Доктора';
    protected static ?string $modelLabel = 'Доктор';
    protected static ?string $pluralModelLabel = 'Доктора';
